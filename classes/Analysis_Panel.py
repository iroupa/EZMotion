...
#         self.m_panel1_1 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                    wx.TAB_TRAVERSAL)
#         self.m_panel1_1.SetMinSize(wx.Size(-1, 15))
#         self.m_panel1_1.SetMaxSize(wx.Size(-1, 15))
#
#         bSizer1_1.Add(self.m_panel1_1, 0, wx.EXPAND | wx.ALL, 5)
#
...
#
#         bSizer1_2_1_1.Add(self.m_static_analysis_type, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#         bSizer1_2_1_1.Add(self.m_comboBox_analysis_type, 0, wx.ALL, 5)
#
#         sbSizer1_2_1.Add(bSizer1_2_1_1, 1, wx.EXPAND, 5)
#
#         bSizer1_2.Add(sbSizer1_2_1, 1, wx.EXPAND, 17)
#
#         bSizer1.Add(bSizer1_2, 1, wx.EXPAND, 17)
#
#         bSizer1_3 = wx.BoxSizer(wx.VERTICAL)
#
#         bSizer1_3.SetMinSize(wx.Size(-1, 15))
#         self.m_panel1_3 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                    wx.TAB_TRAVERSAL)
#         self.m_panel1_3.SetMinSize(wx.Size(-1, 15))
#         self.m_panel1_3.SetMaxSize(wx.Size(-1, 15))
#
#         bSizer1_3.Add(self.m_panel1_3, 1, wx.ALL | wx.EXPAND, 5)
#
...
#
#         bSizer1_4_1_1.Add(self.m_static_input_files_folder, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#
#         bSizer1_4_1_1.Add(self.m_dirPicker_input_files_folder, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         sbSizer1_4_1.Add(bSizer1_4_1_1, 1, wx.EXPAND, 5)
#
#         bSizer1_4.Add(sbSizer1_4_1, 1, wx.EXPAND, 5)
#
...
#         self.m_panel1_5 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                    wx.TAB_TRAVERSAL)
#         self.m_panel1_5.SetMinSize(wx.Size(-1, 15))
#         self.m_panel1_5.SetMaxSize(wx.Size(-1, 15))
#
#         bSizer1_5.Add(self.m_panel1_5, 1, wx.ALL | wx.EXPAND, 5)
#
...
#
#         bSizer1_6_1_1.Add(self.m_static_modeling_file, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#                                                             )
#         bSizer1_6_1_1.Add(self.m_filePicker_modeling_file, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_6_1_2.Add(self.m_static_model_state_q, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         self.m_filePicker_model_state_q = wx.FilePickerCtrl(sbSizer1_6_1.GetStaticBox(), wx.ID_ANY, wx.EmptyString,
#                                                             u"Select a file", u"*.*", wx.DefaultPosition,
#                                                             wx.DefaultSize, wx.FLP_DEFAULT_STYLE, validator = DirObjectValidator('file'))
#         bSizer1_6_1_2.Add(self.m_filePicker_model_state_q, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_6_1_3.Add(self.m_static_model_state_qp, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
#
#         self.m_filePicker_model_state_qp = wx.FilePickerCtrl(sbSizer1_6_1.GetStaticBox(), wx.ID_ANY, wx.EmptyString,
#                                                              u"Select a file", u"*.*", wx.DefaultPosition,
#                                                              wx.DefaultSize, wx.FLP_DEFAULT_STYLE, validator = DirObjectValidator('file'))
#         bSizer1_6_1_3.Add(self.m_filePicker_model_state_qp, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_6_1_4.Add(self.m_static_model_drivers_labels, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#         bSizer1_6_1_4.Add(self.m_filePicker_model_drivers_labels, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_6_1_5.Add(self.m_static_model_data, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#                                                          wx.FLP_DEFAULT_STYLE, validator = DirObjectValidator('file'))
#         bSizer1_6_1_5.Add(self.m_filePicker_model_data, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_6_1_6.Add(self.m_static_force_files, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         self.m_dirPicker_force_files = wx.DirPickerCtrl(sbSizer1_6_1.GetStaticBox(), wx.ID_ANY, wx.EmptyString,
#                                                         u"Select a folder", wx.DefaultPosition, wx.DefaultSize,
#                                                         wx.DIRP_DEFAULT_STYLE, validator = DirObjectValidator('dir'))
#         bSizer1_6_1_6.Add(self.m_dirPicker_force_files, 1, wx.ALL, 5)
#
...
#
#         bSizer1_6_1_7.Add(self.m_static_inertial_parameters, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         self.m_filePicker_inertial_parameters = wx.FilePickerCtrl(sbSizer1_6_1.GetStaticBox(), wx.ID_ANY,
#                                                                   wx.EmptyString, u"Select a file", u"*.*",
#                                                                   wx.DefaultPosition, wx.DefaultSize,
#                                                                   wx.FLP_DEFAULT_STYLE, validator = DirObjectValidator('file'))
#         bSizer1_6_1_7.Add(self.m_filePicker_inertial_parameters, 1, wx.ALL, 5)
#
...
#
#         bSizer_1_6_1_8.Add(self.m_static_msk_database, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
#
#         self.m_filePicker_msk_database = wx.FilePickerCtrl(sbSizer1_6_1.GetStaticBox(), wx.ID_ANY, wx.EmptyString,
#                                                            u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize,
#                                                            wx.FLP_DEFAULT_STYLE, validator = DirObjectValidator('file'))
#         bSizer_1_6_1_8.Add(self.m_filePicker_msk_database, 1, wx.ALL, 5)
#
#         sbSizer1_6_1.Add(bSizer_1_6_1_8, 1, wx.EXPAND, 5)
#
#         bSizer1_6.Add(sbSizer1_6_1, 0, wx.EXPAND, 5)
#
...
#         self.m_panel1_7 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                    wx.TAB_TRAVERSAL)
#         self.m_panel1_7.SetMinSize(wx.Size(-1, 15))
#
#         bSizer1_7.Add(self.m_panel1_7, 0, wx.EXPAND | wx.ALL, 5)
#
...
#
#         bSizer1_8_1_1.Add(self.m_static_init_time, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_8_1_1.Add(self.m_textCtrl_init_time, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_8_1_2.Add(self.m_static_end_time, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_8_1_2.Add(self.m_textCtrl_end_time, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#
#         bSizer1_8_1_3.Add(self.m_static_sampling_frequency, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         self.m_textCtrl_sampling_frequency = wx.TextCtrl(sbSizer1_8_1.GetStaticBox(), wx.ID_ANY, u"100",
#                                                          wx.DefaultPosition, wx.DefaultSize, 0, validator = TextObjectValidator('no-alpha'))
#
#         bSizer1_8_1_3.Add(self.m_textCtrl_sampling_frequency, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
#         sbSizer1_8_1.Add(bSizer1_8_1_3, 0, wx.EXPAND, 5)
#
#         bSizer1_8.Add(sbSizer1_8_1, 0, wx.EXPAND, 5)
#
...
#         self.m_panel1_9 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                    wx.TAB_TRAVERSAL)
#         self.m_panel1_9.SetMinSize(wx.Size(-1, 15))
#
#         bSizer1_9.Add(self.m_panel1_9, 0, wx.EXPAND | wx.ALL, 5)
#
...
#
#         bSizer1_10_1_1.Add(self.m_static_outputs_folder, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.TOP, 5)
#
#         self.m_dirPicker_outputs_folder = wx.DirPickerCtrl(sbSizer1_10_1.GetStaticBox(), wx.ID_ANY, wx.EmptyString,
#                                                            u"Select a folder", wx.DefaultPosition, wx.DefaultSize,
#                                                            wx.DIRP_DEFAULT_STYLE, validator = DirObjectValidator('dir'))
#         bSizer1_10_1_1.Add(self.m_dirPicker_outputs_folder, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
#
...
#         self.m_panel1_11 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                     wx.TAB_TRAVERSAL)
#         self.m_panel1_11.SetMinSize(wx.Size(-1, 15))
#
#         bSizer1_11.Add(self.m_panel1_11, 0, wx.EXPAND | wx.ALL, 5)
#
...
#
#         bSizer1_12.Add(self.m_button_analysis, 1, wx.ALL | wx.EXPAND, 5)
#
#         bSizer1.Add(bSizer1_12, 0, wx.EXPAND, 5)
#
#         bSizer1_13 = wx.BoxSizer(wx.VERTICAL)
#
#         bSizer1_13.SetMinSize(wx.Size(-1, 15))
#         self.m_panel1_13 = wx.Panel(self.m_scrolledWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
#                                     wx.TAB_TRAVERSAL)
#         self.m_panel1_13.SetMinSize(wx.Size(-1, 15))
#
#         bSizer1_13.Add(self.m_panel1_13, 0, wx.EXPAND | wx.ALL, 5)
#
#         bSizer1.Add(bSizer1_13, 0, wx.EXPAND, 5)
#
...
#
#         sbSizer1_14_1.Add(self.m_textCtrl_Messages, 0, wx.ALL | wx.EXPAND, 5)
#
#         self.m_button_Messages_clear = wx.Button(sbSizer1_14_1.GetStaticBox(), wx.ID_ANY, u"Clear", wx.DefaultPosition,
#                                                  wx.DefaultSize, 0)
#         sbSizer1_14_1.Add(self.m_button_Messages_clear, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
#
#         bSizer1_14.Add(sbSizer1_14_1, 0, wx.EXPAND, 5)
#
...
#
#         # Apply tool tips to widgets
#         # self.m_static_model_file.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_model_state_q.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_drivers_labels.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_model_data.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_init_time.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_end_time.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_sampling_frequency.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_outputs_folder.SetToolTip(wx.ToolTip("Enter purchased item"))
#         # self.m_static_model_file.ToolTip("Update Database")
#
#         # Connect Events
...
#                 self.m_static_inertial_parameters.Show()
#                 self.m_filePicker_inertial_parameters.Show()
#                 self.m_static_msk_database.Hide()
#                 self.m_filePicker_msk_database.Hide()
#                 self.Layout()
...
#                     # Run analysis
#                     if self.m_comboBox_analysis_type.GetValue() == 'Kinematic':
#                         run_inverse_analysis(self.m_comboBox_analysis_type.GetValue(),
...
#
#                     elif self.m_comboBox_analysis_type.GetValue() == 'Forward Dynamic':
#                         run_forward_analysis(self.m_comboBox_analysis_type.GetValue(),
#                                              self.m_filePicker_modeling_file.GetPath(),
#                                              self.m_filePicker_model_state_q.GetPath(),
#                                              self.m_filePicker_model_state_qp.GetPath(),
#                                              self.m_filePicker_inertial_parameters.GetPath(),
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    #     input_files_folder_fpath = self.m_dirPicker_input_files_folder.GetPath()
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_filePicker_modeling_file.SetPath(
                    #         [os.path.join(input_files_folder_fpath, x) for x in os.listdir(input_files_folder_fpath) if
                    #          x.endswith('.mod')][0])
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_filePicker_model_outputs.SetPath(
                    #         [os.path.join(input_files_folder_fpath, x) for x in os.listdir(input_files_folder_fpath) if
                    #          x.endswith('.out')][0])
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_filePicker_model_markers.SetPath(
                    #         [os.path.join(input_files_folder_fpath, x) for x in os.listdir(input_files_folder_fpath) if
                    #          x.endswith('.mkr')][0])
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_filePicker_model_loc_coords.SetPath(
                    #         [os.path.join(input_files_folder_fpath, x) for x in os.listdir(input_files_folder_fpath) if
                    #          x.endswith('.jt')][0])
                    #
                    #     model_loc_coords_fpath = [os.path.join(input_files_folder_fpath, x) for x in os.listdir(input_files_folder_fpath) if x.endswith('.jt')][0]
                    #
                    #     lines_info = compute_lines_info(model_loc_coords_fpath, model_coordinates_data)
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_comboBox_plot_data.Clear()
                    #
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_comboBox_plot_data.Append(model_plot_variables_labels)
                    #     self.GrandParent.m_panel_visualization.m_inputs_panel.m_comboBox_plot_data.SetSelection(1)
                    #
                    #     # Label of the variable of the model to plot in axis 2
                    #     ax2_variable_label = self.GrandParent.m_panel_visualization.m_inputs_panel.m_comboBox_plot_data.GetStringSelection()
                    #
                    #     # Filter raw data of the selected variable of the model
                    #     if self.GrandParent.m_panel_visualization.m_inputs_panel.m_comboBox_plot_filter_choice.GetValue() == 'Yes':
                    ...
                    #     ax2_xlim, ax2_ylim = compute_axis_limits(model_plot_variables[ax2_variable_label], nRigidBodies,
                    #                                              'y')
                    #
                    #     self.GrandParent.m_panel_visualization.m_plot_panel.draw_plots(nRigidBodies=nRigidBodies,
