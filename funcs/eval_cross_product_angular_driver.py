...
def evaluate_cross_product_angular_driver(nCoordinates, constraintByType, dataConst, q, qpto, phi, dPhidq, niu, gamma, rowIn):
    """
...
"""
    ...
    gamma[constraintRowIndex] = -uLength*vLength*(np.sin(theta*thetap**2 - np.cos(theta)*thetapp) - 2*np.dot(uVectorPerppto, vVectorpto))
